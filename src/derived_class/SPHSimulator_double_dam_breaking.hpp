#ifndef SPHSIMULATOR_DOUBLE_DAM_BREAKING_H
#define SPHSIMULATOR_DOUBLE_DAM_BREAKING_H
#include "SPHSimulator_rigid_body.hpp"
#include <cmath>

class SPHSimulator_double_dam_breaking : public SPHSimulator_rigid_body
{
public:
	SPHSimulator_double_dam_breaking(int N,  Real uParticle_len, Real dt, Real eta, Real B, Real alpha, Real rest_density, int with_viscosity, int with_XSPH, int solver_type)
...
#endif // SPHSIMULATOR_DOUBLE_DAM_BREAKING_H
