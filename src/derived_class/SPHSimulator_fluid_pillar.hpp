#ifndef SPHSIMULATOR_FLUID_PILLAR_H
#define SPHSIMULATOR_FLUID_PILLAR_H
#include "SPHSimulator_rigid_body.hpp"
#include <cmath>

class SPHSimulator_fluid_pillar : public SPHSimulator_rigid_body
{
public:
	SPHSimulator_fluid_pillar(int N,  Real uParticle_len, Real dt, Real eta, Real B, Real alpha, Real rest_density, int with_viscosity, int with_XSPH, int solver_type)
	...
	virtual void generate_particles() override
    {
            ...
            origin = RealVector3(0.0, 0.0, 5*N*particle_radius);
...
#endif // SPHSIMULATOR_FLUID_PILLAR_H
